...
//private _msg = "-->>> ExileClient_gui_inventory_event_onSlotDoubleClick called";
//systemChat _msg;
//diag_log _msg;
...
switch (ctrlIDC _control) do 
{
	...
	case 6214: { _itemClassName = ""; [] execVM "custom\deployableVehicles\functions\ExileClient_DeployableVehicles_network_deployVehicleRequest.sqf"; }; 
